...
export const ROLE_PERMISSIONS = {
  superadmin:  ['superadmin','dashboard','notices','athletes','coaches','schedule','injuries','performance','scouting','contracts','reports','settings','billing','transfers','pay'],
  admin:       ['dashboard','notices','athletes','coaches','schedule','injuries','performance','scouting','contracts','reports','settings','billing','transfers','pay'],
  coach:       ['dashboard','notices','athletes','coaches','schedule','injuries','performance','settings','transfers'],
  physio:      ['dashboard','notices','athletes','injuries','settings'],
