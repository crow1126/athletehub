...
export const PLAN_LIMITS = {
  superadmin: {
    ...
    staff_limit:    99999,
    modules:        ['superadmin','dashboard','notices','athletes','coaches','schedule','injuries','performance','scouting','contracts','reports','settings','billing','transfers','player-hub','pay'],
  ...
  trial: {
    ...
    athlete_limit:  999,
    staff_limit:    99,
    modules:        ['dashboard','notices','athletes','coaches','schedule','injuries','performance','scouting','contracts','reports','settings','billing','transfers','player-hub'],
  ...
  starting_xi: {
    ...
    athlete_limit:  40,
    staff_limit:    15,
    modules:        ['dashboard','notices','athletes','coaches','schedule','injuries','reports','settings','billing','player-hub'],
  ...
  captain: {
    ...
    athlete_limit:  999999,
    staff_limit:    99999,
    // Captain has access to everything — checked via canAccessModule returning true
    modules:        ['dashboard','notices','athletes','coaches','schedule','injuries','performance','scouting','contracts','reports','settings','billing','transfers','player-hub'],
...
export function canAccessModule(plan, module) {
  // Superadmin and Captain have unrestricted access to all modules
  if (plan === 'superadmin' || plan === 'captain' || plan === 'elite' || plan === 'academy') return true
