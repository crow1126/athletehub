...
export const PLAN_LIMITS = {
  ...
  academy: {
    ...
    athlete_limit:  100,
    staff_limit:    10,
    modules:        ['dashboard','athletes','coaches','schedule','injuries','performance','scouting','reports','settings','billing'],
    description:    '100 athletes · 10 staff · Full medical, analytics & scouting',
  },
  elite: {
    ...
    staff_limit:    999,
    modules:        ['dashboard','athletes','coaches','schedule','injuries','performance','scouting','contracts','reports','settings','billing'],
    description:    'Unlimited athletes & staff · All modules including contracts',
  },
}
